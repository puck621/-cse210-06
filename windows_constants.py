...
ASTEROIDS_IMAGES = {
    "l": [f"{ROOT}/assets/images\\{i:03}.png" for i in range(2,13)],
    "m": [f"{ROOT}/assets/images\\{i:03}.png" for i in range(14,28)],
    "s": [f"{ROOT}/assets/images\\{i:03}.png" for i in range(29,40)]
}
ASTEROIDS_DELAY = 0.5
ASTEROIDS_RATE = 4
ASTEROIDS_POINTS = 50
...
MEDIUM_ASTEROIDS_SPIN = -2
MEDIUM_ASTEROIDSK_RADIUS = 5

SMALL_ASTEROIDS_SPIN = 5
SMALL_ASTEROIDS_RADIUS = 2
